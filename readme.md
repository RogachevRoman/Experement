...
Далее заполняем его, в нашем случае, радномными числами от -500 до 500, с помощью метода FillArray.
...
FillArray(array,-500,500); заполняем массив рандомными числами от 10 до 100.
